...
import { AvatarSpriteComponent } from './avatar-sprite.component';

function draw(
  changes: Partial<AvatarConfig> = {},
  facing: 'right' | 'left' = 'right',
): HTMLElement {
  const f = TestBed.createComponent(AvatarSpriteComponent);
...
beforeEach(async () => {
  await TestBed.configureTestingModule({ imports: [AvatarSpriteComponent] }).compileComponents();
});
