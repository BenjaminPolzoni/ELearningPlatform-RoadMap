...
import { BadgeCatalog, GrantedBadge } from '../../data-access/badges/badges.models';
...
@Component({
  ...
  imports: [PixelIconComponent, StreakComponent, LivesComponent, AvatarSpriteComponent],
  template: `
    <div class="rk-hud">
      <!-- Profile: hexagonal shield + identity -->
      <div style="display:flex;align-items:center;gap:1rem">
        <span class="rk-shield"><app-avatar-sprite [config]="row().avatar" [height]="108" /></span>
