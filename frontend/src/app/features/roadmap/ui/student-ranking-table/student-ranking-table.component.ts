...
import { RankingRow, RankingAnonRow, StudentRankingView } from '../../data-access/ranking/ranking.models';
 ...
 */
@Component({
  selector: 'app-student-ranking-table',
    ...
    @for (f of rows(); track f.position) {
      ...
      >
        ...
        <span style="display:flex;align-items:center;gap:0.5rem;min-width:0">
          <app-avatar-sprite class="rk-row__avatar" [config]="f.avatar" [height]="52" />
...
export class StudentRankingTableComponent {
