...
// the asset folders of the 3D world (src/assets/roadmap/world-3d/Assets/House/<Biome>),
...
export const BIOMES: BiomeInfo[] = [
  { id: 'Desert', label: 'Desierto', icon: '🏜️', available: true, previewImage: '/assets/roadmap/img/map_desert_tile_vertical.png' },
  { id: 'Forest', label: 'Bosque', icon: '🌲', available: true, previewImage: '/assets/roadmap/img/map_jungle_tile.png' },
  { id: 'Sandstone', label: 'Arenisca', icon: '🏛️', available: true, previewImage: '/assets/roadmap/img/map_castle_tile.png' },
  { id: 'Snow', label: 'Nieve', icon: '❄️', available: true, previewImage: '/assets/roadmap/img/map_snow_tile.png' },
  { id: 'Nether', label: 'Nether', icon: '🔥', available: false },
  // Space: islands without water/clouds, planet-nodes and a ship as the avatar (see buildChallengeIsland in /assets/roadmap/world-3d/index.html).
