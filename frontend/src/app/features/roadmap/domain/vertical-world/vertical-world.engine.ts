import { NodeStatus } from '../../data-access/roadmap/roadmap.models';
import { Biome } from '../../data-access/roadmap/biomes';
...
export const WORLD_APPEARANCE: Record<WorldTheme, WorldAppearanceConfig> = {
  desert: {
    tile: '/assets/roadmap/img/desert_animated.gif',
    goal: 'piramide',
  ...
  jungle: {
    tile: '/assets/roadmap/img/jungle_animated.gif',
    goal: 'templo',
  ...
  castle: {
    tile: '/assets/roadmap/img/graveyard_animated.gif',
    goal: 'castillo',
  ...
  snow: {
    tile: '/assets/roadmap/img/biome_taiga.jpg',
    goal: 'refugio',
  ...
  nether: {
    tile: '/assets/roadmap/img/nether_animated.gif',
    goal: 'fortaleza',
