...
const BASE_CHARACTERS = '/assets/roadmap/world-3d/Assets/CharacterV2/Characters/gltf/';
const USEFUL_BASE = '/assets/roadmap/world-3d/Assets/CharacterV2/Assets/gltf/';
const BASE_MIXED = '/assets/roadmap/world-3d/Assets/Cosmetics/mixed/';
const BASE_STARS = '/assets/roadmap/world-3d/Assets/Cosmetics/stars/';
 ...
 * Port of the orchestration of `src/assets/roadmap/world-3d/avatar-preview.html`
