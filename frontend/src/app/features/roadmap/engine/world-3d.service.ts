...
import type { EnvironmentTheme } from '../data-access/theme/theme.service';
import {
  ATTACHMENT_EMOJI,
...
const G = '/assets/roadmap/world/Hexagon/Assets/gltf';
...
export class World3dService {
  ...
  async init(
    ...
    texLoader.load('/assets/roadmap/world/game_store_bg.jpg', (tex) => {
    ...
    texLoader.load('/assets/roadmap/world/arcade_bg.jpg', (tex) => {
      tex.mapping = THREE.EquirectangularReflectionMapping;
      tex.colorSpace = THREE.SRGBColorSpace;
      this.arcadeBg = tex;
