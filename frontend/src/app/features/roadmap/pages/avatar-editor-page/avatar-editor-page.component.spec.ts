...
import { AvatarEditorPageComponent } from './avatar-editor-page.component';

describe('AvatarEditor', () => {
  let fixture: ComponentFixture<AvatarEditorPageComponent>;
  let el: HTMLElement;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [AvatarEditorPageComponent],
      providers: [provideRouter([])],
    }).compileComponents();
    fixture = TestBed.createComponent(AvatarEditorPageComponent);
