...
import {
  ...
  NewBadge,
  BadgeType,
} from '../../data-access/badges/badges.models';
...
import { BADGE_ICONS } from '../../ui/badge-icons/badge-icons';
import { GENERIC_ICONS } from '../../ui/badge-icons/generic-icons';
...
@Component({
  ...
  imports: [PixelIconComponent, FormsModule, RouterLink],
  ...
  template: `
    <div class="flex items-center justify-between gap-4 mb-6">
      ...
      <a routerLink="/roadmap/teacher" class="btn btn-sm btn-ghost border border-neutral/40 ui-font text-[8px]">
        ◀ Volver al editor
      </a>
    </div>
...
export class BadgesCatalogPageComponent {
