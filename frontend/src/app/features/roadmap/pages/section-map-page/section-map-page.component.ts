...
@Component({
  selector: 'app-section-map-page',
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [AvatarSpriteComponent, RouterLink, UpperCasePipe],
  ...
  template: `
    @if (section(); as u) {
      ...
      <div class="p-8 text-center text-white/70">
        ...
        <a routerLink="/roadmap/student" class="btn btn-primary btn-sm mt-4">Volver al inicio</a>
      </div>
    }
  `,
})
export class SectionMapPageComponent {
