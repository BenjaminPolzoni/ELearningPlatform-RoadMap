    ...
    @if (store.current(); as a) {
      <div class="mx-auto max-w-4xl p-6">
        ...
        <div class="flex items-center justify-between gap-4 border-b border-base-300 pb-4">
          <a routerLink="/roadmap/teacher" class="btn btn-sm btn-ghost ui-font text-[9px]">
            ← Asignaturas
          </a>
        ...
        <div class="mt-4 flex flex-wrap items-center gap-3">
          ...
          <app-educa-badge>🌍 {{ counts().sections }} unidades</app-educa-badge>
          <app-educa-badge>🎯 {{ counts().modules }} módulos</app-educa-badge>
          <app-educa-badge>📦 {{ counts().attachments }} anexos</app-educa-badge>
        </div>
        ...
        @if (editing(); as e) {
          <app-entity-editor-dialog [kind]="e.kind" [heading]="e.heading"
