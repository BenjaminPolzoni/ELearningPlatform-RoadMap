import type { Role } from '../core/auth/auth-mock.service';
import type { BadgeOrigin } from '../core/data/badges.models';
import type { Difficulty, NodeType } from '../core/data/roadmap.models';
import type { AttachmentType } from '../core/educa/models';
