...
**Total: 20 ítems abiertos, 3 pagados.** Última revisión: se registró la falta de assets para el bioma de nieve en el rediseño pixel art estático (`04-engine-2-5d.md` ítem #3). Antes: al rediseñar el avatar (género +
